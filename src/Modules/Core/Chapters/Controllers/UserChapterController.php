...
namespace Modules\Core\Chapters\Controllers;

use Core\Http\Responses\Json\CreatedResponse;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;
use Modules\Core\Chapters\Presenters\User\UserShowChapter;
use Modules\Core\Chapters\Presenters\User\UserStoreChapter;
