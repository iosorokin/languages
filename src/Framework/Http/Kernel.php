...
use Framework\Http\Middleware\AuthorizeAdmin;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Framework\Http\Middleware\TrustProxies::class,
        \Illuminate\Http\Middleware\HandleCors::class,
        \Framework\Http\Middleware\PreventRequestsDuringMaintenance::class,
    ...
    protected $routeMiddleware = [
        ...
        'signed' => \Framework\Http\Middleware\ValidateSignature::class,
